...
): ISubscriptionCheckpointRepository
{
    ...
    public async ValueTask<ISubscriptionCheckpointRepository.StoreResult> Store(
    ...
    )
    {
        ...
        {
            1 => new ISubscriptionCheckpointRepository.StoreResult.Success(Checkpoint.From(position)),
            0 => new ISubscriptionCheckpointRepository.StoreResult.Ignored(),
            2 => new ISubscriptionCheckpointRepository.StoreResult.Mismatch(),
            _ => new ISubscriptionCheckpointRepository.StoreResult.Mismatch(),
        };
    }
